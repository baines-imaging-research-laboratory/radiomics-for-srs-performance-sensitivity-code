classdef (Abstract) MATLABClassifier < Classifier
    ...
    methods (Access = public, Static = false)
        ...
        function oGuessingResults = Guess(obj, oLabelledFeatureValues, NameValueArgs)
            ...
            oGuessingResults = obj.GuessWithOptionalDuplicatedSamplesValidationOverride(oLabelledFeatureValues, NameValueArgs.JournalingOn, bOverrideDuplicatedSamplesValidation);            
        end
