classdef Labels
    ...
    methods (Access = public)
        ...
        function oFeatureValues = GetLabelledFeatureValues(obj)
            oFeatureValues = FileIOUtils.LoadMatFile(fullfile(obj.sPathToFileLocation, obj.sIdTag + " [CentralLibrary].mat"), Labels.chCentralLibraryMatFileVarName);
        end
