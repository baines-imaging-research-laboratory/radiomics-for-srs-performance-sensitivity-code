classdef F020023_MajorAxisLength < ShapeAndSizeFeature
    % F020023_MajorAxisLength
    %
    % ROI major axis length calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F020023"
        sFeatureDisplayName = "Major Axis Length"
    ...
    methods (Access = public)
        function obj = F020023_MajorAxisLength()
        end
    end
    methods (Access = protected)
        function dValue = ExtractFeature(obj, oImageVolumeHandler, oFeatureExtractionParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the major axis length feature value.
            %
            % INPUT ARGUMENTS:
            ...
            dValue = 4*sqrt(oImageVolumeHandler.GetCurrentRegionOfInterestPrincipalComponentAnalysisLambdaMajor(oFeatureExtractionParameters));
        end
    end
