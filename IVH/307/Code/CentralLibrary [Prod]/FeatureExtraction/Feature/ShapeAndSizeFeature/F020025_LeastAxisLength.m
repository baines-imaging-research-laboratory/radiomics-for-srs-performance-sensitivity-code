classdef F020025_LeastAxisLength < ShapeAndSizeFeature
    % F020002_SurfaceArea
    %
    % ROI least axis length calculation. 
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F020025"
        sFeatureDisplayName = "Least Axis Length"
    ...
    methods (Access = public)
        function obj = F020025_LeastAxisLength()
        end
    end
    methods (Access = protected)
        function dValue = ExtractFeature(obj, oImageVolumeHandler, oFeatureExtractionParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the least axis length feature value.
            %
            % INPUT ARGUMENTS:
            ...
            dValue = 4*sqrt(oImageVolumeHandler.GetCurrentRegionOfInterestPrincipalComponentAnalysisLambdaLeast(oFeatureExtractionParameters));
        end
    end
