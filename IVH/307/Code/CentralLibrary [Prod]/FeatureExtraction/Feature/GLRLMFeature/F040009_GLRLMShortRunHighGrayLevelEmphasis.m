classdef F040009_GLRLMShortRunHighGrayLevelEmphasis < GLRLMFeature
    %F040009_GLRLMShortRunHighGrayLevelEmphasis
    %
    % ROI GLRLM short run high gray level emphasis calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F040009"
        sFeatureDisplayName = "GLRLM Short Run High Gray Level Emphasis"
    end    
    ...
    methods (Access = public)
        ...
        function obj = F040009_GLRLMShortRunHighGrayLevelEmphasis()
        end
    end
    ...
    methods (Access = protected, Static = true)
        ...
        function dValue = ExtractGLRLMFeature(m2dGLRLM, oFeatureExtractorParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the gray level run length matrix short run high gray level emphasis feature value.
            %
            % INPUT ARGUMENTS:
            ...
            % Temporary term
            dCoefficient = m2dGLRLM.*(vdCols.^2)./(vdRows.^2);
