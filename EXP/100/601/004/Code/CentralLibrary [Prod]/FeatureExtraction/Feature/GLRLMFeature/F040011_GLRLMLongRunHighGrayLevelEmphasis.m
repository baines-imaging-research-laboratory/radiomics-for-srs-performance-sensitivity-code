classdef F040011_GLRLMLongRunHighGrayLevelEmphasis < GLRLMFeature
    %F040011_GLRLMLongRunHighGrayLevelEmphasis
    %
    % ROI GLRLM long run high gray level emphasis calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F040011"
        sFeatureDisplayName = "GLRLM Long Run High Gray Level Emphasis"
    end    
    ...
    methods (Access = public)
        ...
        function obj = F040011_GLRLMLongRunHighGrayLevelEmphasis()
        end
    end
    ...
    methods (Access = protected, Static = true)
        ...
        function dValue = ExtractGLRLMFeature(m2dGLRLM, oFeatureExtractorParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the gray level run length matrix long run high gray level emphasis feature value.
            %
            % INPUT ARGUMENTS:
