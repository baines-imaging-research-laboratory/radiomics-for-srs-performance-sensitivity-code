classdef (Abstract) AdvancedErrorMetricsCalculator
    ...
    methods (Access = public, Static = true)
        ...
        function vdAUCPerBootstrap = CalculateAUC_0Point632(c1oGuessResultPerBootstrapPartition, c1oGuessResultForTrainingAndTestingOnAllData)
            ...
            if ~iscell(c1oGuessResultForTrainingAndTestingOnAllData)
                c1oGuessResultForTrainingAndTestingOnAllData = {c1oGuessResultForTrainingAndTestingOnAllData};
            end
            
            dNumTrainAndTestOnAllDataReps = length(c1oGuessResultForTrainingAndTestingOnAllData);
            vdTrainAndTestOnAllDataAUCs = zeros(dNumTrainAndTestOnAllDataReps,1);
            
            for dTrainAndTestOnAllDataIndex=1:dNumTrainAndTestOnAllDataReps            
                vdTrainAndTestOnAllDataAUCs(dTrainAndTestOnAllDataIndex) = ErrorMetricsCalculator.CalculateAUC(c1oGuessResultForTrainingAndTestingOnAllData{dTrainAndTestOnAllDataIndex}, 'JournalingOn', false);
            end
            
            dAUC_x_x = mean(vdTrainAndTestOnAllDataAUCs);
        ...
        function vdAUCPerBootstrap = CalculateAUC_0Point632Plus(c1oGuessResultPerBootstrapPartition, c1oGuessResultForTrainingAndTestingOnAllData)
