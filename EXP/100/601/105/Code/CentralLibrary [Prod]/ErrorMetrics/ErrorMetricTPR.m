classdef ErrorMetricTPR < ErrorMetricWithConfidenceThreshold
    %ErrorMetricTPR
    %
    % Error metric TPR object for optimization.
    ...
    methods (Access = public, Static = false)
        ...
        function obj = ErrorMetricTPR(bCalculateOptimalThreshold, xThresholdParameter)
            %obj = ErrorMetricTPR(bCalculateOptimalThreshold, xThresholdParameter)
            %
            % SYNTAX:
            %  obj = ErrorMetricTPR(true, vsCalculateOptimalThresholdCriteria)
            %  obj = ErrorMetricTPR(false, dUserDefinedConfidenceThreshold)
            %
            % DESCRIPTION:
            %  Constructor for the error metric TPR object
            %
            % INPUT ARGUMENTS:
    ...
    methods (Access = protected)
        ...
        function dErrorMetricValue = CalculateMetricWithThreshold(obj, oGuessResult, dThreshold, NameValueArgs)
            ...
            %   metric.
            %  dThreshold: Cutoff value to assess the TPR.
            %  NameValueArgs:
