classdef F020021_Perimeter < ShapeAndSizeFeature
    % F020021_Perimeter
    %
    % ROI perimeter calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F020021"
        sFeatureDisplayName = "Perimeter"
        bIsValidFor2DImageVolumes = true
        bIsValidFor3DImageVolumes = false
    end    
    ...
    methods (Access = public)
        function obj = F020021_Perimeter()
        end
    end
    methods (Access = protected)
        function dValue = ExtractFeature(obj, oImageVolumeHandler, oFeatureExtractionParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the perimeter feature value.
            %
            % INPUT ARGUMENTS:
            ...
            % Fetch the area
            dValue = oImageVolumeHandler.GetCurrentRegionOfInterestPerimeter_mm(oFeatureExtractionParameters);
        end
