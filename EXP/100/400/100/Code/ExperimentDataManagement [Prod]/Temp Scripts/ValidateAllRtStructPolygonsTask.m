classdef ValidateAllRtStructPolygonsTask < ImageVolumeViewerTask
    ...
    methods (Access = public)
        ...
        function obj = ValidateAllRtStructPolygonsTask(chProgressCacheFilePath, chStudyDatabaseLoadPath, chStudyDatabaseSavePath)
        ...
        function Resume(obj, chNewProgressCacheFilePath, chNewStudyDatabaseSavePath)
            arguments
                obj (1,1) ValidateAllRtStructPolygonsTask
    ...
    methods (Access = protected)
        ...
        function InitializeForBegin(obj)
            ...
            obj.dNumberOfPatients = obj.oStudyDatabase.GetNumberOfPatients();
        ...
        function c1chProgressText = GetProgressText(obj)
            ...
            c1chProgressText = {...
                ['Patient #: ', num2str(obj.dCurrentPatientIndex), '/', num2str(obj.dNumberOfPatients)],...
                ['Study #: ', num2str(obj.dCurrentStudyIndex), '/', num2str(obj.dCurrentNumberOfStudies)],...
    ...
    methods (Access = private)
        ...
        function EnableDisablePolygon(obj)
            ...
            if ~bCurrentPolygonEnabled
                vdPolyColour_rgb = ValidateAllRtStructPolygonsTask.vdCurrentPolygonEnabledColour_rgb;
            else
                vdPolyColour_rgb = ValidateAllRtStructPolygonsTask.vdCurrentPolygonDisabledColour_rgb;
            end
            ...
            if obj.dCurrentPolygonNumber < obj.dCurrentNumberOfPolygons
                ...
                if obj.dCurrentRegionOfInterestNumber < obj.dCurrentNumberOfRegionsOfInterest
                    ...
                    if obj.dCurrentImageVolumeIndex < obj.dCurrentNumberOfImageVolumes
                        ...
                        if obj.dCurrentStudyIndex < obj.dCurrentNumberOfStudies
                            % increment Imaging Study
                            
                            obj.dCurrentStudyIndex = obj.dCurrentStudyIndex + 1;
                        else
                            % new Imaging Study
                            obj.dCurrentStudyIndex = 1;
                            
                            if obj.dCurrentPatientIndex < obj.dNumberOfPatients
                                % increment patient
                                obj.dCurrentPatientIndex = obj.dCurrentPatientIndex + 1;
                                obj.oCurrentPatient = obj.oStudyDatabase.GetPatientByPrimaryId(obj.dCurrentPatientIndex);
                                obj.dCurrentNumberOfStudies = obj.oCurrentPatient.GetNumberOfImagingStudies();
                            else
                                % task complete
                                bTaskComplete = true;
                            end
                        ...
                        % new Imaging Study wrap-up
                        if ~bTaskComplete
                            obj.oCurrentImagingStudy = obj.oCurrentPatient.GetImagingStudyByStudyNumber(obj.dCurrentStudyIndex);
            ...
            if obj.dCurrentPolygonNumber > 1
                ...
                if obj.dCurrentRegionOfInterestNumber > 1
                    ...
                    if obj.dCurrentImageVolumeIndex > 1
                        ...
                        if obj.dCurrentStudyIndex > 1
                            % decrement Imaging Study
                            obj.dCurrentStudyIndex = obj.dCurrentStudyIndex - 1;
                        else
                            % new Imaging Study
                            obj.dCurrentStudyIndex = 1;
                            
                            if obj.dCurrentPatientIndex > 1
                                % decrement patient
                                obj.dCurrentPatientIndex = obj.dCurrentPatientIndex - 1;
                            else
                                % error
                            ...
                            obj.oCurrentPatient = obj.oStudyDatabase.GetPatientByPrimaryId(obj.dCurrentPatientIndex);
                            obj.dCurrentNumberOfStudies = obj.oCurrentPatient.GetNumberOfImagingStudies();
                            obj.dCurrentStudyIndex = obj.dCurrentNumberOfStudies;
                        end
        ...
        function SetCurrentRegionOfInterestColourAndVisibility(obj)
            ...
            obj.GetImageVolumeViewerApp().SetRegionOfInterestColour(obj.dCurrentRegionOfInterestNumber, ValidateAllRtStructPolygonsTask.vdCurrentRegionOfInterestColour_rgb);
        end
