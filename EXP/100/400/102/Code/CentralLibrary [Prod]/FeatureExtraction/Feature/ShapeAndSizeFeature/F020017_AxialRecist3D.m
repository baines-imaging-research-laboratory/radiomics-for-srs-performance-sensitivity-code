classdef F020017_AxialRecist3D < ShapeAndSizeFeature
    % F020017_AxialRecist3D
    %
    % ROI axis recist calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F020017"
        sFeatureDisplayName = "Axial Recist 3D"
    ...
    methods (Access = public)
        function obj = F020017_AxialRecist3D()
        end
    end
    methods (Access = protected)
        function dValue = ExtractFeature(obj, oImageVolumeHandler, oFeatureExtractionParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the axial recist 3D feature value.
            %
            % INPUT ARGUMENTS:
            ...
            dValue = oImageVolumeHandler.GetCurrentRegionOfInterestAxialRecist_mm(oFeatureExtractionParameters);
        end
    end
