classdef F030006_GLCMInverseDifference < GLCMFeature
    %F030006_GLCMInverseDifference
    %
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F030006"
        sFeatureDisplayName = "GLCM Inverse Difference"
    end    
    ...
    methods (Access = public)
        ...
        function obj = F030006_GLCMInverseDifference()
        end
    end
    ...
    methods (Access = protected, Static = true)
        ...
        function dValue = ExtractGLCMFeature(m2dGLCM, oFeatureExtractorParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the gray level co-occurence matrix inverse difference feature value.
            %
            % INPUT ARGUMENTS:
