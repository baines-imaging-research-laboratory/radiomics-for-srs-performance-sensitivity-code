classdef F030021_GLCMIDM < GLCMFeature
    %F030021_GLCMIDM
    %
    ...
    methods (Access = protected, Static = true)
        ...
        function dValue = ExtractGLCMFeature(m2dGLCM, oFeatureExtractorParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the gray level co-occurence matrix inverse differrence moment feature value.
            %
            % INPUT ARGUMENTS:
            ...
            vdTerm1 = m2dGLCM(:);
            vdTerm2 = (vdRows-vdCols).^2;
            
            dValue = sum(vdTerm1./(1+(vdTerm2)));
        end
    end
