classdef F020014_NRLSphericity < ShapeAndSizeFeature
    % F020014_NRLSphericity
    %
    % ROI normalized radial length sphericity calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F020014"
        sFeatureDisplayName = "Normalized Radial Length Sphericity"
    ...
    methods (Access = public)
        function obj = F020014_NRLSphericity()
        end
    end
    methods (Access = protected)
        function dValue = ExtractFeature(obj, oImageVolumeHandler, oFeatureExtractionParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the normalized radial length sphericity feature value.
            %
            % INPUT ARGUMENTS:
            ...
            % Calculate the mean and std. of the normalized lengths
            dMean = mean(vdNormalizedRadialLengths);
            dStd = std(vdNormalizedRadialLengths);            
