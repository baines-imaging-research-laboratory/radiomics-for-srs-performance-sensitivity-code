classdef F010019_RootMeanSquare < FirstOrderFeature
    %Image
    %
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F010019"
        sFeatureDisplayName = "Root Mean Square"
    end    
    ...
    methods (Access = public)
        ...
        function obj = F010019_RootMeanSquare()
        end
    end
    methods (Access = protected)
        function dValue = ExtractFeature(obj,oImage, oFeatureExtractionParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the root mean square feature value.
            %
            % INPUT ARGUMENTS:
            ...
            dValue = sqrt( sum(double(m3xImageData(m3bMask)).^2)/numel(m3xImageData(m3bMask)) );
        end
