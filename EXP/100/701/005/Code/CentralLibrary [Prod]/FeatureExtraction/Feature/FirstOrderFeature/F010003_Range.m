classdef F010003_Range < FirstOrderFeature
    %Image
    %
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F010003"
        sFeatureDisplayName = "Range"
    end    
    ...
    methods (Access = protected)
        function dValue = ExtractFeature(obj,oImage, oFeatureExtractionParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the range feature value.
            %
            % INPUT ARGUMENTS:
            ...
            % In v2019 of MATLAB this should be replaced by "range(m3xImageData(m3bMask),'all')"
            % to avoid copying of image.
            m3xMaskedImage =  m3xImageData(m3bMask);          
            dValue = range(m3xMaskedImage(:));
