classdef ErrorMetricFNR < ErrorMetricWithConfidenceThreshold
    %ErrorMetricFNR
    %
    % Error metric FNR object for optimization.
    ...
    methods (Access = public, Static = false)
        ...
        function obj = ErrorMetricFNR(bCalculateOptimalThreshold, xThresholdParameter)
            %obj = ErrorMetricFNR(bCalculateOptimalThreshold, xThresholdParameter)
            %
            % SYNTAX:
            %  obj = ErrorMetricFNR(true, vsCalculateOptimalThresholdCriteria)
            %  obj = ErrorMetricFNR(false, dUserDefinedConfidenceThreshold)
            %
            % DESCRIPTION:
            %  Constructor for the error metric FNR object
            %
            % INPUT ARGUMENTS:
    ...
    methods (Access = protected)
        ...
        function dErrorMetricValue = CalculateMetricWithThreshold(obj, oGuessResult, dThreshold, NameValueArgs)
            ...
            %   metric.
            %  dThreshold: Cutoff value to assess the FNR.
            %  NameValueArgs:
