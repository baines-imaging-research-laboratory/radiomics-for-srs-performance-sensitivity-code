classdef ErrorMetricMCR < ErrorMetricWithConfidenceThreshold
    %ErrorMetricMCR
    %
    % Error metric MCR object for optimization.
    ...
    methods (Access = public, Static = false)
        ...
        function obj = ErrorMetricMCR(bCalculateOptimalThreshold, xThresholdParameter)
            %obj = ErrorMetricMCR(bCalculateOptimalThreshold, xThresholdParameter)
            %
            % SYNTAX:
            %  obj = ErrorMetricMCR(true, vsCalculateOptimalThresholdCriteria)
            %  obj = ErrorMetricMCR(false, dUserDefinedConfidenceThreshold)
            %
            % DESCRIPTION:
            %  Constructor for the error metric MCR object
            %
            % INPUT ARGUMENTS:
    ...
    methods (Access = protected)
        ...
        function dErrorMetricValue = CalculateMetricWithThreshold(obj, oGuessResult, dThreshold, NameValueArgs)
            ...
            %   metric.
            %  dThreshold: Cutoff value to assess the MCR.
            %  NameValueArgs:
