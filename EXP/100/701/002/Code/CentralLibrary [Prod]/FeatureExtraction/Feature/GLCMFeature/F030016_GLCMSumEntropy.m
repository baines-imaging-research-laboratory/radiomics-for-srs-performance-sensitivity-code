classdef F030016_GLCMSumEntropy < GLCMFeature
    %F030016_GLCMSumEntropy
    %
    % ROI GLCM sum entropy calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F030016"
        sFeatureDisplayName = "GLCM Sum Entropy"
    end    
    ...
    methods (Access = public)
        ...
        function obj = F030016_GLCMSumEntropy()
        end
    end
    ...
    methods (Access = protected, Static = true)
        ...
        function dValue = ExtractGLCMFeature(m2dGLCM, oFeatureExtractorParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the gray level co-occurence matrix sum entropy feature value.
            %
            % INPUT ARGUMENTS:
            ...
            vdCoeff1 = [];
            vdUniqueTerm1 = unique(vdTerm1);
            for iIter = 1:numel(vdUniqueTerm1)
                
                vdTempGLCM = vdGLCM(vdTerm1 == vdUniqueTerm1(iIter));
