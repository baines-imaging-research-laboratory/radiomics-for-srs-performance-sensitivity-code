function m3ui32BinnedImage = BinImage_NonInteger_To_uint32(m3iRawImage, vdRowBounds, vdColBounds, vdSliceBounds, dFirstBinEdge, dBinSize, dNumberOfBins)
    ...
    for dColIndex = vdColBounds(1):vdColBounds(2)
        for dRowIndex = vdRowBounds(1):vdRowBounds(2)
            dBinnedValue = BinImage_PerformBinCalculation(...
                m3iRawImage(dRowIndex, dColIndex, dSliceIndex),...
