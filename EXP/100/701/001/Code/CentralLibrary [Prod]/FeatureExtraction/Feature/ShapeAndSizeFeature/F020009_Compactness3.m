classdef F020009_Compactness3 < ShapeAndSizeFeature
    % F020009_Compactness3
    %
    % ROI compactness 3 calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F020009"
        sFeatureDisplayName = "Compactness 3"
    ...
    methods (Access = public)
        function obj = F020009_Compactness3()
        end
    end
    methods (Access = protected)
        function dValue = ExtractFeature(obj, oImageVolumeHandler, oFeatureExtractionParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the compactness 3 feature value.
            %
            % INPUT ARGUMENTS:
            ...
            % Calculate compactness 3
            dValue = dSurfaceArea^2/dVolume;
        end
    end
