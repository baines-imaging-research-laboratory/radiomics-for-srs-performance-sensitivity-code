classdef F030014_GLCMInverseVariance < GLCMFeature
    %F030014_GLCMInverseVariance
    %
    % ROI GLCM inverse variance calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F030014"
        sFeatureDisplayName = "GLCM Inverse Variance"
    end    
    ...
    methods (Access = public)
        ...
        function obj = F030014_GLCMInverseVariance()
        end
    end
    ...
    methods (Access = protected, Static = true)
        ...
        function dValue = ExtractGLCMFeature(m2dGLCM, oFeatureExtractorParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the gray level co-occurence matrix inverse variance feature value.
            %
            % INPUT ARGUMENTS:
            ...
            vdTerm1 = m2dGLCM(:);
            vdTerm2 = abs(vdRows - vdCols).^2;
            
            % Find out where i = j and remove
            dIndex = find(vdTerm2 == 0);
            vdTerm1(dIndex) = [];
            vdTerm2(dIndex) = [];
