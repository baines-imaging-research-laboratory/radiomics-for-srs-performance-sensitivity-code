classdef F040008_GLRLMShortRunLowGrayLevelEmphasis < GLRLMFeature
    %F040008_GLRLMShortRunLowGrayLevelEmphasis
    %
    % ROI GLRLM short run low gray level emphasis calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F040008"
        sFeatureDisplayName = "GLRLM Short Run Low Gray Level Emphasis"
    end    
    ...
    methods (Access = public)
        ...
        function obj = F040008_GLRLMShortRunLowGrayLevelEmphasis()
        end
    end
    ...
    methods (Access = protected, Static = true)
        ...
        function dValue = ExtractGLRLMFeature(m2dGLRLM, oFeatureExtractorParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the gray level run length matrix short run low gray level emphasis feature value.
            %
            % INPUT ARGUMENTS:
            ...
            % Temporary term
            dCoefficient = m2dGLRLM./((vdRows.*vdCols).^2);
