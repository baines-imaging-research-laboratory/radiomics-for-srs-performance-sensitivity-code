...
%     end
    ...
    methods (Access = public)
        ...
        function PerformMorphologicalTransform(obj, vdRegionOfInterestNumbers, fnTransformFunction, varargin)
            arguments
                obj
                vdRegionOfInterestNumbers (1,:) double {MustBeValidRegionOfInterestNumbers(obj, vdRegionOfInterestNumbers)}
                fnTransformFunction (1,1) function_handle
            end
            arguments (Repeating)
                varargin
            end
    ...
    methods (Access = {?LabelMapRegionsOfInterest, ?ImagingObjectTransform})
        ...
        function ApplyMorphologicalTransform(obj, vdRegionOfInterestNumbers, fnFunctionHandle, varargin)
            arguments
                obj
                vdRegionOfInterestNumbers (1,:) double {MustBeValidRegionOfInterestNumbers(obj, vdRegionOfInterestNumbers)}
            ...
            for dRoiIndex=1:length(vdRegionOfInterestNumbers)
                ...
                m3bMask = fnFunctionHandle(m3bMask, varargin{:});
