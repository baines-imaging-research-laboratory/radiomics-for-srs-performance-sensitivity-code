classdef F030020_GLCMDiagonalMoment < GLCMFeature
    %F030020_GLCMDiagonalMoment
    %
    % ROI GLCM diagonal moment calculation.
    ...
    properties (Constant = true, GetAccess = public)
        ...
        sFeatureDisplayName = "GLCM Diagonal Moment"
    end    
    ...
    methods (Access = public)
        ...
        function obj = F030020_GLCMDiagonalMoment()
        end
    end
    ...
    methods (Access = protected, Static = true)
        ...
        function dValue = ExtractGLCMFeature(m2dGLCM, oFeatureExtractorParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the gray level co-occurence matrix diagonal moment feature value.
            %
            % INPUT ARGUMENTS:
            ...
            vdTerm1 = 1/2*abs(vdRows-vdCols);
            vdTerm2 = m2dGLCM(:);
            
            dValue = sum(sqrt(vdTerm1.*vdTerm2));
        end
    end
