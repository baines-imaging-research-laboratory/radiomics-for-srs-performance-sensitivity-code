classdef F020020_Area < ShapeAndSizeFeature
    % F020020_Area
    %
    % ROI 2D area calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F020020"
        sFeatureDisplayName = "Area"
    ...
    methods (Access = protected)
        function dValue = ExtractFeature(obj, oImageVolumeHandler, oFeatureExtractionParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the area feature value.
            %
            % INPUT ARGUMENTS:
            ...
            % Fetch the area
            dValue = oImageVolumeHandler.GetCurrentRegionOfInterestArea_mm2(oFeatureExtractionParameters);
        end
