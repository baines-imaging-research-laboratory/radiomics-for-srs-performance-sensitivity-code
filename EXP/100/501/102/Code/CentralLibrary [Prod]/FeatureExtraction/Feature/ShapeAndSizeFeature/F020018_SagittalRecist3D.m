classdef F020018_SagittalRecist3D < ShapeAndSizeFeature
    % F020018_SagittalRecist3D
    %
    % ROI sagittal recist calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F020018"
        sFeatureDisplayName = "Sagittal Recist 3D"
    ...
    methods (Access = public)
        function obj = F020018_SagittalRecist3D()
        end
    end
    methods (Access = protected)
        function dValue = ExtractFeature(obj, oImageVolumeHandler, oFeatureExtractionParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the sagittal recist 3D feature value.
            %
            % INPUT ARGUMENTS:
            ...
            dValue = oImageVolumeHandler.GetCurrentRegionOfInterestSagittalRecist_mm(oFeatureExtractionParameters);
        end
    end
