classdef F020001_Volume < ShapeAndSizeFeature
    % F020001_Volume
    %
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F020001"
        sFeatureDisplayName = "Volume"
    ...
    methods (Access = protected)
        function dValue = ExtractFeature(obj, oImageVolumeHandler, oFeatureExtractionParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the volume feature value.
            %
            % INPUT ARGUMENTS:
            ...
            % Fetch the volume
            dValue = oImageVolumeHandler.GetCurrentRegionOfInterestVolume_mm3(oFeatureExtractionParameters);
        end
