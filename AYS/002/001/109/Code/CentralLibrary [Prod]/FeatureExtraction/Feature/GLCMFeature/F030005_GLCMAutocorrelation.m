classdef F030005_GLCMAutocorrelation < GLCMFeature
    %F030005_GLCMAutocorrelation
    %
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F030005"
        sFeatureDisplayName = "GLCM Autocorrelation"
    end    
    ...
    methods (Access = public)
        ...
        function obj = F030005_GLCMAutocorrelation()
        end
    end
    ...
    methods (Access = protected, Static = true)
        ...
        function dValue = ExtractGLCMFeature(m2dGLCM, oFeatureExtractorParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the gray level co-occurence matrix autocorrelation feature value.
            %
            % INPUT ARGUMENTS:
