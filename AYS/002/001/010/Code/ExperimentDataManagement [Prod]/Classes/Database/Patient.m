classdef Patient < handle
    ...
    properties (SetAccess = private, GetAccess = public)
        ...
        eGPAGroup GPAGroup 
        eDSGPAGroup DSGPAGroup {ValidationUtils.MustBeEmptyOrScalar} = DSGPAGroup.empty
...
%         oTreatmentOutcomes TreatmentOutcomes {ValidationUtils.MustBeEmptyOrScalar} = TreatmentOutcomes.empty
    ...
    methods (Access = public)
        ...
        function obj = Patient(dPrimaryId, dSecondaryId, eGender, dAge, ePrimaryCancerActive, ePrimaryCancerSite, ePrimaryCancerHistology, eSystemicMetastasesStatus, eExtracranialDiseaseActive, eSystemicTherapyStatus, eSteroidStatus, eWHOScore, eGPAGroup, eDSGPAGroup, dtFirstSRSTreatmentDate, dtOutOfFieldProgressionDate, dtDateOfDeath, eCauseOfDeath, voBrainMetastases, sPreTreatmentT1wCEMRIFilePath)
            ...
            obj.eGPAGroup = eGPAGroup;
            obj.eDSGPAGroup = eDSGPAGroup;
        ...
        function eGPAGroup = GetGPAGroup(obj)
            eGPAGroup = obj.eGPAGroup;
        end
                
        function eDSGPAGroup = GetDSGPAGroup(obj)
            eDSGPAGroup = obj.eDSGPAGroup;
        end
        ...
        function SaveImageVolume(obj, oImageVolume, sIMGPPCode, NameValueArgs)
            ...
            if isfolder(fullfile(chImagingDatabaseRootPath, chPreTreatmentT1wCEMRIFolderPath, sFolderName))
                warning(...
                    'Patient:SaveImageVolune:ImageVolumeDirectoryAlreadyExists',...
    ...
    methods (Access = public, Static = true)
        ...
        function oPatient = CreateFromStudyDatabaseSpreadsheet(dPatientId, c2xPerPatientData, c2xPerBMData)
            ...
            % see if DS-GPA available
            if ismissing(c2xPerPatientData{dPatientRowIndex,26}) % DS-GPA not relevant for all primary cancer types
                eDSGPAGroup = DSGPAGroup.empty;
            else
                eDSGPAGroup = DSGPAGroup.getEnumFromDatabaseValues(c2xPerPatientData{dPatientRowIndex,26});
            end
            ...
            oPatient = Patient(...
                ...
                GPAGroup.getEnumFromDatabaseValues(c2xPerPatientData{dPatientRowIndex,21}),...
                eDSGPAGroup,...
