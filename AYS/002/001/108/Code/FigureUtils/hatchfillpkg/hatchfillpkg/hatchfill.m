function H = hatchfill(A,STYL,ANGLE,SPACING,FACECOL, NameValueArgs)
...
arguments
    ...
    SPACING
    FACECOL
    NameValueArgs.LineWidth = 0.5
    NameValueArgs.LineColour = [0 0 0]
end
...
linec = NameValueArgs.LineColour;
linew = NameValueArgs.LineWidth;    
specksize = 2;
