classdef F010004_Minimum < FirstOrderFeature
    %Image
    %
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F010004"
        sFeatureDisplayName = "Miniumum"
    end    
    ...
    methods (Access = protected)
        function dValue = ExtractFeature(obj,oImage, oFeatureExtractionParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the minimum feature value.
            %
            % INPUT ARGUMENTS:
            ...
            % In v2019 of MATLAB this should be replaced by "min(m3xImageData(m3bMask),[],'all','omitnan')"
            % to avoid copying of image.
            m3xMaskedImage =  m3xImageData(m3bMask);          
            dValue = min(m3xMaskedImage(:));
