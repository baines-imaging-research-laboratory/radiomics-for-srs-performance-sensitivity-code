classdef F040007_GLRLMHighGrayLevelRunEmphasis < GLRLMFeature
    %F040007_GLRLMHighGrayLevelRunEmphasis
    %
    % ROI GLRLM high gray level run emphasis calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F040007"
        sFeatureDisplayName = "GLRLM High Gray LEvel Run Emphasis"
    end    
    ...
    methods (Access = public)
        ...
        function obj = F040007_GLRLMHighGrayLevelRunEmphasis()
        end
    end
    ...
    methods (Access = protected, Static = true)
        ...
        function dValue = ExtractGLRLMFeature(m2dGLRLM, oFeatureExtractorParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the gray level run length matrix high gray level run emphasis feature value.
            %
            % INPUT ARGUMENTS:
