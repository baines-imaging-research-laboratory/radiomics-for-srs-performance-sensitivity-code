classdef ExperimentManager
    ...
    properties (Constant = true, GetAccess = private)
        ...
        sExperimentManifestCodesFileSSVarName = "sSSCode"
        ...
        sExperimentManifestCodesFileFVVarName = "m2sFVCodes"
    end
    ...
    methods (Access = public, Static = true)
        ...
        function [sSampleSelectionCode, vsClinicalFeatureValueCodes, vsRadiomicsFeatureValueCodes, sLabelsCode, sTuningSetCode, sModelCode, sHPOCode, sObjFcnCodeForHPO, vsFeatureSelectorCodes, vsObjFcnCodesForFeatureSelectors] = LoadExperimentManifestCodesMatFile(sManifestCodesFilePath)
            arguments
            ...
            if ~Experiment.IsRunning
                ...
                [sSampleSelectionCode, m2sFeatureValueCodes, sLabelsCode, sTuningSetCode, sModelCode, sHPOCode, sObjFcnCodeForHPO, vsFeatureSelectorCodes, vsObjFcnCodesForFeatureSelectors] = ...
                    FileIOUtils.LoadMatFile(...
                    fullfile(sManifestCodesFilePath, ExperimentManager.sExperimentManifestCodesFilename),...
                    ExperimentManager.sExperimentManifestCodesFileSSVarName,...
                ...
                if sum(vbFeatureCodeIsClinical) + sum(vbFeatureCodeIsRadiomics) ~= size(m2sFeatureValueCodes,2)
                    error(...
                        ...
                        'A feature values code must be clinical or radiomics.');
                end
                
                vsClinicalFeatureValueCodes = m2sFeatureValueCodes(2,vbFeatureCodeIsClinical);
                vsRadiomicsFeatureValueCodes = m2sFeatureValueCodes(2,vbFeatureCodeIsRadiomics);
