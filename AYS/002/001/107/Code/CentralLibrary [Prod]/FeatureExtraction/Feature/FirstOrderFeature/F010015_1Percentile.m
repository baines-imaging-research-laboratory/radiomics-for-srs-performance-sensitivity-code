classdef F010015_1Percentile < FirstOrderFeature
    %Image
    %
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F010015"
        sFeatureDisplayName = "1st Percentile"
    end    
    ...
    methods (Access = public)
        ...
        function obj = F010015_1Percentile()
        end
    end
    methods (Access = protected)
        function dValue = ExtractFeature(obj,oImage, oFeatureExtractionParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the 1st percentile feature value.
            %
            % INPUT ARGUMENTS:
            ...
            dValue = fhPctlCustom(double(m3xImageData(m3bMask)),1);
