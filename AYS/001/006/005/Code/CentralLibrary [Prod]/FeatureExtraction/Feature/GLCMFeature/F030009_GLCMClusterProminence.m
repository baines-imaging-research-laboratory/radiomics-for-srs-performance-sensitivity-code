classdef F030009_GLCMClusterProminence < GLCMFeature
    %F030009_GLCMClusterProminence
    %
    % ROI GLCM cluster prominence calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F030009"
        sFeatureDisplayName = "GLCM Cluster Prominence"
    end    
    ...
    methods (Access = public)
        ...
        function obj = F030009_GLCMClusterProminence()
        end
    end
    ...
    methods (Access = protected, Static = true)
        ...
        function dValue = ExtractGLCMFeature(m2dGLCM, oFeatureExtractorParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the gray level co-occurence matrix cluster prominence feature value.
            %
            % INPUT ARGUMENTS:
            ...
            vdTerm1 = (vdRows + vdCols - vdRowMeanProb - vdColMeanProb) .^ 4;
            vdTerm2 = m2dGLCM(:);
