classdef F030010_GLCMClusterShade < GLCMFeature
    %F030010_GLCMClusterShade
    %
    % ROI GLCM cluster shade calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F030010"
        sFeatureDisplayName = "GLCM Cluster Shade"
    end    
    ...
    methods (Access = public)
        ...
        function obj = F030010_GLCMClusterShade()
        end
    end
    ...
    methods (Access = protected, Static = true)
        ...
        function dValue = ExtractGLCMFeature(m2dGLCM, oFeatureExtractorParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the gray level co-occurence matrix cluster shade feature value.
            %
            % INPUT ARGUMENTS:
            ...
            vdTerm1 = (vdRows + vdCols - vdRowMeanProb - vdColMeanProb) .^ 3;
            vdTerm2 = m2dGLCM(:);
