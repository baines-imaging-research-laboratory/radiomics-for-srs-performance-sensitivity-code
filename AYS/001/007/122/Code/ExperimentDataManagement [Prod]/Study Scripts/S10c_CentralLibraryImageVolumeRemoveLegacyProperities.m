function S10c_CentralLibraryImageVolumeRemoveLegacyProperities()

chDatabaseRootPath = Constants.S10b_root; % post clean-up
chRootPath = Constants.S10c_root;
...
% no "update" command needed, the properities will be deleted upon
% load/save
