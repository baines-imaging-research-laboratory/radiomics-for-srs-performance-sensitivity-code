classdef F030007_GLCMInverseDifferenceMoment < GLCMFeature
    %F030007_GLCMInverseDifferenceMoment
    %
    % ROI GLCM inverse difference moment calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F030007"
        sFeatureDisplayName = "GLCM Inverse Difference Moment"
    end    
    ...
    methods (Access = public)
        ...
        function obj = F030007_GLCMInverseDifferenceMoment()
        end
    end
    ...
    methods (Access = protected, Static = true)
        ...
        function dValue = ExtractGLCMFeature(m2dGLCM, oFeatureExtractorParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the gray level co-occurence matrix inverse difference moment feature value.
            %
            % INPUT ARGUMENTS:
