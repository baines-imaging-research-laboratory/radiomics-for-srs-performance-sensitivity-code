classdef F010018_99Percentile < FirstOrderFeature
    %Image
    %
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F010018"
        sFeatureDisplayName = "99th Percentile"
    end    
    ...
    methods (Access = public)
        ...
        function obj = F010018_99Percentile()
        end
    end
    methods (Access = protected)
        function dValue = ExtractFeature(obj,oImage, oFeatureExtractionParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the 99th percentile feature value.
            %
            % INPUT ARGUMENTS:
            ...
            dValue = fhPctlCustom(double(m3xImageData(m3bMask)),99);
