classdef F020019_CoronalRecist3D < ShapeAndSizeFeature
    % F020019_CoronalRecist3D
    %
    % ROI coronal recist calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F020019"
        sFeatureDisplayName = "Coronal Recist 3D"
    ...
    methods (Access = public)
        function obj = F020019_CoronalRecist3D()
        end
    end
    methods (Access = protected)
        function dValue = ExtractFeature(obj, oImageVolumeHandler, oFeatureExtractionParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the coronal recist 3D feature value.
            %
            % INPUT ARGUMENTS:
            ...
            dValue = oImageVolumeHandler.GetCurrentRegionOfInterestCoronalRecist_mm(oFeatureExtractionParameters);
        end
    end
