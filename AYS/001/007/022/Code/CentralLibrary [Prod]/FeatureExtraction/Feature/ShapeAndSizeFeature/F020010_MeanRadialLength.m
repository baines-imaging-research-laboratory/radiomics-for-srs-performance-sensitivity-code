classdef F020010_MeanRadialLength < ShapeAndSizeFeature
    % F020010_MeanRadialLength
    %
    % ROI mena radial length calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F020010"
        sFeatureDisplayName = "Mean Radial Length"
    ...
    methods (Access = public)
        function obj = F020010_MeanRadialLength()
        end
    end
    methods (Access = protected)
        function dValue = ExtractFeature(obj, oImageVolumeHandler, oFeatureExtractionParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the mean radial length feature value.
            %
            % INPUT ARGUMENTS:
            ...
            % Calculate mean radial length
            dValue = mean(vdRadialLengths);
        end
    end
