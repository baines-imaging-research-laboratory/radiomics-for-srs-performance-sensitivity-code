...
% %                 vdTranslations_mm (1,3) double {mustBeFinite} = [0 0 0]
        ...
        function NormalizeIntensityWithZScoreTransform(obj, dNumberOfStandardDeviations, dRegionOfInterestNumber)
            arguments
                obj (1,1) ImageVolume
            ...
            oTransform = ZScoreIntensityNormalizationTransform(obj, dNumberOfStandardDeviations, dRegionOfInterestNumber);
