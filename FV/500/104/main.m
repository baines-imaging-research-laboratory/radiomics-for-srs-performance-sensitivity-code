...
oDB = ExperimentManager.Load("DB-002");
...
oRecord = CustomFeatureExtractionRecord("FV-500-104", "Clinical features from DB-002 with categorical groupings for primary cancer site & histology matching Rodrigues 2013", m2dFeatures);
...
oFV = ExperimentFeatureValues("FV-500-104");
