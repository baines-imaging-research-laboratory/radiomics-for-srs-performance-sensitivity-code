classdef F040002_GLRLMLongRunEmphasis < GLRLMFeature
    %F040002_GLRLMLongRunEmphasis
    %
    % ROI GLRLM long run emphasis calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F040002"
        sFeatureDisplayName = "GLRLM Long Run Emphasis"
    end    
    ...
    methods (Access = public)
        ...
        function obj = F040002_GLRLMLongRunEmphasis()
        end
    end
    ...
    methods (Access = protected, Static = true)
        ...
        function dValue = ExtractGLRLMFeature(m2dGLRLM, oFeatureExtractorParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the gray level run length matrix long run emphasis feature value.
            %
            % INPUT ARGUMENTS:
