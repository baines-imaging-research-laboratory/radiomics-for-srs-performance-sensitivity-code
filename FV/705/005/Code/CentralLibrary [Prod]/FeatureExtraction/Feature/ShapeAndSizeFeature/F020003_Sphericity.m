classdef F020003_Sphericity < ShapeAndSizeFeature
    % F020003_Sphericity
    %
    % ROI sphericity calculation.
    ...
    properties (Constant = true, GetAccess = public)
        sFeatureName = "F020003"
        sFeatureDisplayName = "Sphericity"
    ...
    methods (Access = public)
        function obj = F020003_Sphericity()
        end
    end
    methods (Access = protected)
        function dValue = ExtractFeature(obj, oImageVolumeHandler, oFeatureExtractionParameters)
            ...
            %
            % DESCRIPTION:
            %  Extracts the sphericity feature value.
            %
            % INPUT ARGUMENTS:
            ...
            dValue = pi^(1/3)*(6*dVolume)^(2/3)/dSurfaceArea;
        end
